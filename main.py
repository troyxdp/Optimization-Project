...
if __name__ == '__main__':
    ...
    parser.add_argument('--mutation-rate', type=float, help='The mutation rate to use for the evolutionary algorithm - 0.02 is recommended', default=0.05)
    parser.add_argument('--nt', type=int, help='Size of subset to be used for tournament in tournament selection', default=12)
    parser.add_argument('--no-improvement-max-generations', type=int, help='Number of generations to wait for an improvement before terminating', default=50)
    parser.add_argument('--num-mutation-retries', type=int, help='Number of times to inject randomness upon premature convergence', default=2)
    parser.add_argument('--mutation-retry-scale', type=float, help='Value to scale mutation rate by when injecting randomness', default=1.5)
