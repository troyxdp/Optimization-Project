...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-folder', type=str, help='Path to output CSV stat files to', default='/home/troyxdp/Documents/University Work/Optimization/Project/statistics')
    ...
    solution = ea_agent.run_evolutionary_algorithm(mutation_rate=args.mutation_rate, no_improvement_max_generations=args.wait, n_t=args.nt, num_offspring=args.num_offspring, output_folder=args.output_folder)
    if solution:
