...
from classes.sudoku import Sudoku, StandardSudoku, KillerSudoku, Cage
...
class KillerSudokuEvolutionaryAgent(SudokuEvolutionaryAgent):
    ...
    def __init__(
        ...
        # Instantiate grids
        print("Initializing population...")
        self.population : list[KillerSudoku] = [cage_test_sudoku]
        for i in range(1, len(grid) * len(grid) * 100):
